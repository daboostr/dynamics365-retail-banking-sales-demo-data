...
namespace Demo.Dataverse.Model
{
	...
	public enum contact_educationcode
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		PostSecondary = 213100001,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		College = 213100002,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		University = 213100003,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		PostSecondary1 = 213100004,
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string dhfsinam_ChurnRisk = "dhfsinam_churnrisk";
			public const string dhfsinam_CSAT15 = "dhfsinam_csat15";
			public const string dhfsinam_Health = "dhfsinam_health";
			public const string dhfsinam_LifeStage = "dhfsinam_lifestage";
			public const string dhfsinam_Segment = "dhfsinam_segment";
			public const string dhfsinam_Sentiment = "dhfsinam_sentiment";
			...
			public const string gbb_DADavidsonDemoData = "gbb_dadavidsondemodata";
			...
			public const string msdh_AUM = "msdh_aum";
			public const string msdh_aum_Base = "msdh_aum_base";
			public const string msdh_LastReview = "msdh_lastreview";
			public const string msdh_NextReview = "msdh_nextreview";
			public const string msdh_WealthPlanner = "msdh_wealthplanner";
			...
			public const string msfsi_Branch = "msfsi_branch";
			public const string msfsi_fhlookupplaceholder = "msfsi_fhlookupplaceholder";
			public const string msfsi_integrationkey = "msfsi_integrationkey";
			public const string msfsi_IsManagedByBankSystem = "msfsi_ismanagedbybanksystem";
			public const string msfsi_Joindate = "msfsi_joindate";
			public const string msfsi_Person = "msfsi_person";
			public const string msfsi_placeholder = "msfsi_placeholder";
			public const string msfsi_profiletier = "msfsi_profiletier";
			public const string msfsi_Tenureyears = "msfsi_tenureyears";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_churnrisk")]
		public virtual dhfsinam_fsichurn? dhfsinam_ChurnRisk
		{
			get
			{
				return ((dhfsinam_fsichurn?)(EntityOptionSetEnum.GetEnum(this, "dhfsinam_churnrisk")));
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_ChurnRisk");
				this.SetAttributeValue("dhfsinam_churnrisk", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("dhfsinam_ChurnRisk");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_csat15")]
		public System.Nullable<int> dhfsinam_CSAT15
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("dhfsinam_csat15");
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_CSAT15");
				this.SetAttributeValue("dhfsinam_csat15", value);
				this.OnPropertyChanged("dhfsinam_CSAT15");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_health")]
		public virtual dhfsinam_fsihealth? dhfsinam_Health
		{
			get
			{
				return ((dhfsinam_fsihealth?)(EntityOptionSetEnum.GetEnum(this, "dhfsinam_health")));
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_Health");
				this.SetAttributeValue("dhfsinam_health", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("dhfsinam_Health");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_lifestage")]
		public virtual dhfsinam_fsilifestage? dhfsinam_LifeStage
		{
			get
			{
				return ((dhfsinam_fsilifestage?)(EntityOptionSetEnum.GetEnum(this, "dhfsinam_lifestage")));
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_LifeStage");
				this.SetAttributeValue("dhfsinam_lifestage", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("dhfsinam_LifeStage");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_segment")]
		public virtual dhfsinam_fsisegment? dhfsinam_Segment
		{
			get
			{
				return ((dhfsinam_fsisegment?)(EntityOptionSetEnum.GetEnum(this, "dhfsinam_segment")));
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_Segment");
				this.SetAttributeValue("dhfsinam_segment", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("dhfsinam_Segment");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dhfsinam_sentiment")]
		public virtual dhfsinam_fsisentiment? dhfsinam_Sentiment
		{
			get
			{
				return ((dhfsinam_fsisentiment?)(EntityOptionSetEnum.GetEnum(this, "dhfsinam_sentiment")));
			}
			set
			{
				this.OnPropertyChanging("dhfsinam_Sentiment");
				this.SetAttributeValue("dhfsinam_sentiment", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("dhfsinam_Sentiment");
			}
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("gbb_dadavidsondemodata")]
		public string gbb_DADavidsonDemoData
		{
			get
			{
				return this.GetAttributeValue<string>("gbb_dadavidsondemodata");
			}
			set
			{
				this.OnPropertyChanging("gbb_DADavidsonDemoData");
				this.SetAttributeValue("gbb_dadavidsondemodata", value);
				this.OnPropertyChanged("gbb_DADavidsonDemoData");
			}
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_aum")]
		public Microsoft.Xrm.Sdk.Money msdh_AUM
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.Money>("msdh_aum");
			}
			set
			{
				this.OnPropertyChanging("msdh_AUM");
				this.SetAttributeValue("msdh_aum", value);
				this.OnPropertyChanged("msdh_AUM");
			}
		}
		
		/// <summary>
		/// Value of the AUM in base currency.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_aum_base")]
		public Microsoft.Xrm.Sdk.Money msdh_aum_Base
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.Money>("msdh_aum_base");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_lastreview")]
		public System.Nullable<System.DateTime> msdh_LastReview
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("msdh_lastreview");
			}
			set
			{
				this.OnPropertyChanging("msdh_LastReview");
				this.SetAttributeValue("msdh_lastreview", value);
				this.OnPropertyChanged("msdh_LastReview");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_nextreview")]
		public System.Nullable<System.DateTime> msdh_NextReview
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("msdh_nextreview");
			}
			set
			{
				this.OnPropertyChanging("msdh_NextReview");
				this.SetAttributeValue("msdh_nextreview", value);
				this.OnPropertyChanged("msdh_NextReview");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_wealthplanner")]
		public string msdh_WealthPlanner
		{
			get
			{
				return this.GetAttributeValue<string>("msdh_wealthplanner");
			}
			set
			{
				this.OnPropertyChanging("msdh_WealthPlanner");
				this.SetAttributeValue("msdh_wealthplanner", value);
				this.OnPropertyChanged("msdh_WealthPlanner");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_person")]
		public Microsoft.Xrm.Sdk.EntityReference msfsi_Person
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msfsi_person");
			}
			set
			{
				this.OnPropertyChanging("msfsi_Person");
				this.SetAttributeValue("msfsi_person", value);
				this.OnPropertyChanged("msfsi_Person");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_profiletier")]
		public virtual msfsi_profiletier? msfsi_profiletier
		{
			get
			{
				return ((msfsi_profiletier?)(EntityOptionSetEnum.GetEnum(this, "msfsi_profiletier")));
			}
			set
			{
				this.OnPropertyChanging("msfsi_profiletier");
				this.SetAttributeValue("msfsi_profiletier", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("msfsi_profiletier");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<Demo.Dataverse.Model.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Contact> Referencedcontact_parent_contact
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_parent_contact");
				this.SetRelatedEntities<Demo.Dataverse.Model.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Opportunity> msa_contact_opportunity
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Opportunity>("msa_contact_opportunity", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_opportunity");
				this.SetRelatedEntities<Demo.Dataverse.Model.Opportunity>("msa_contact_opportunity", null, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Opportunity> opportunity_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Opportunity>("opportunity_customer_contacts", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_customer_contacts");
				this.SetRelatedEntities<Demo.Dataverse.Model.Opportunity>("opportunity_customer_contacts", null, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Opportunity> opportunity_parent_contact
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Opportunity>("opportunity_parent_contact", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_parent_contact");
				this.SetRelatedEntities<Demo.Dataverse.Model.Opportunity>("opportunity_parent_contact", null, value);
		...
		public Demo.Dataverse.Model.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<Demo.Dataverse.Model.Account>("contact_customer_accounts", null, value);
		...
		public Demo.Dataverse.Model.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<Demo.Dataverse.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Demo.Dataverse.Model.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public Demo.Dataverse.Model.Contact Referencingcontact_parent_contact
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_parent_contact");
				this.SetRelatedEntity<Demo.Dataverse.Model.Contact>("contact_parent_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Demo.Dataverse.Model.Account msa_contact_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Account>("msa_contact_managingpartner", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_managingpartner");
				this.SetRelatedEntity<Demo.Dataverse.Model.Account>("msa_contact_managingpartner", null, value);
