...
namespace Demo.Dataverse.Model
{
	...
	public partial class Lead : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string msdh_Type = "msdh_type";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_type")]
		public virtual msdh_fsileadtype? msdh_Type
		{
			get
			{
				return ((msdh_fsileadtype?)(EntityOptionSetEnum.GetEnum(this, "msdh_type")));
			}
			set
			{
				this.OnPropertyChanging("msdh_Type");
				this.SetAttributeValue("msdh_type", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("msdh_Type");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Lead> Referencedlead_master_lead
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Lead>("lead_master_lead", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedlead_master_lead");
				this.SetRelatedEntities<Demo.Dataverse.Model.Lead>("lead_master_lead", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.PhoneCall> Lead_Phonecalls
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.PhoneCall>("Lead_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Phonecalls");
				this.SetRelatedEntities<Demo.Dataverse.Model.PhoneCall>("Lead_Phonecalls", null, value);
		...
		public System.Collections.Generic.IEnumerable<Demo.Dataverse.Model.Task> Lead_Tasks
		{
			get
			{
				return this.GetRelatedEntities<Demo.Dataverse.Model.Task>("Lead_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Tasks");
				this.SetRelatedEntities<Demo.Dataverse.Model.Task>("Lead_Tasks", null, value);
		...
		public Demo.Dataverse.Model.Lead Referencinglead_master_lead
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Lead>("lead_master_lead", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
