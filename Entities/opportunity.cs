...
namespace Demo.Dataverse.Model
{
	...
	public partial class Opportunity : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string msdh_Department = "msdh_department";
			public const string msdh_ProductInterest = "msdh_productinterest";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_department")]
		public virtual msdh_fsidepartment? msdh_Department
		{
			get
			{
				return ((msdh_fsidepartment?)(EntityOptionSetEnum.GetEnum(this, "msdh_department")));
			}
			set
			{
				this.OnPropertyChanging("msdh_Department");
				this.SetAttributeValue("msdh_department", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("msdh_Department");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_productinterest")]
		public virtual msdh_fsiproductinterest? msdh_ProductInterest
		{
			get
			{
				return ((msdh_fsiproductinterest?)(EntityOptionSetEnum.GetEnum(this, "msdh_productinterest")));
			}
			set
			{
				this.OnPropertyChanging("msdh_ProductInterest");
				this.SetAttributeValue("msdh_productinterest", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("msdh_ProductInterest");
			}
		}
		...
		public Demo.Dataverse.Model.Contact msa_contact_opportunity
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("msa_contact_opportunity", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_opportunity");
				this.SetRelatedEntity<Demo.Dataverse.Model.Contact>("msa_contact_opportunity", null, value);
		...
		public Demo.Dataverse.Model.Account msa_partner_opportunity
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Account>("msa_partner_opportunity", null);
			}
			set
			{
				this.OnPropertyChanging("msa_partner_opportunity");
				this.SetRelatedEntity<Demo.Dataverse.Model.Account>("msa_partner_opportunity", null, value);
		...
		public Demo.Dataverse.Model.Account opportunity_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Account>("opportunity_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_customer_accounts");
				this.SetRelatedEntity<Demo.Dataverse.Model.Account>("opportunity_customer_accounts", null, value);
		...
		public Demo.Dataverse.Model.Contact opportunity_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("opportunity_customer_contacts", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_customer_contacts");
				this.SetRelatedEntity<Demo.Dataverse.Model.Contact>("opportunity_customer_contacts", null, value);
		...
		public Demo.Dataverse.Model.Account opportunity_parent_account
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Account>("opportunity_parent_account", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_parent_account");
				this.SetRelatedEntity<Demo.Dataverse.Model.Account>("opportunity_parent_account", null, value);
		...
		public Demo.Dataverse.Model.Contact opportunity_parent_contact
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Contact>("opportunity_parent_contact", null);
			}
			set
			{
				this.OnPropertyChanging("opportunity_parent_contact");
				this.SetRelatedEntity<Demo.Dataverse.Model.Contact>("opportunity_parent_contact", null, value);
