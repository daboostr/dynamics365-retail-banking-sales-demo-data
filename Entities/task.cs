...
namespace Demo.Dataverse.Model
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string msdh_AppointmentTask = "msdh_appointmenttask";
			public const string msfsi_comment = "msfsi_comment";
			public const string msfsi_commentmodifiedby = "msfsi_commentmodifiedby";
			public const string msfsi_commentmodifiedon = "msfsi_commentmodifiedon";
			public const string msfsi_relatedpartycontract = "msfsi_relatedpartycontract";
			public const string msfsi_taskdefinition = "msfsi_taskdefinition";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdh_appointmenttask")]
		public Microsoft.Xrm.Sdk.EntityReference msdh_AppointmentTask
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msdh_appointmenttask");
			}
			set
			{
				this.OnPropertyChanging("msdh_AppointmentTask");
				this.SetAttributeValue("msdh_appointmenttask", value);
				this.OnPropertyChanged("msdh_AppointmentTask");
			}
		}
		...
		public Demo.Dataverse.Model.Lead Lead_Tasks
		{
			get
			{
				return this.GetRelatedEntity<Demo.Dataverse.Model.Lead>("Lead_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Tasks");
				this.SetRelatedEntity<Demo.Dataverse.Model.Lead>("Lead_Tasks", null, value);
